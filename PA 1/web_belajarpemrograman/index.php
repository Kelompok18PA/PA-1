...
<head>
	...
	<title>Web Belajar Programming</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Web Belajar Pemrograman</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								...
								<a href="https://twitter.com/login?lang=id" class="fa fa-twitter"></a>
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b>SERVICES</b></h2>
         				<p>
						 ini adalah layanan yang disediakan oleh website kami
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
						 Di sini Anda akan menemukan semua tutorial kuliah yang terkait dengan bahasa pemrograman
						 seperti C dan C++
         				</p>
         			</div>
         		</div>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
						 Di sini Anda akan menemukan semua video tutorial yang terkait dengan bahasa pemrograman seperti C,C++
         				</p>
         			</div>
         		</div>
         		...
         		<!--<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="online_quize/quizhome.php">EXERCISE</a></h3>   
         				<p>
				...
				<div class="container-fluid">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work1.jpg" title="this is a sky image">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work2.jpg" title="this is a sky image">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/c.jpg" title="this is a sky image">
					...
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/cpp.png" title="this is a sky image">
...
<!--										
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div class="img-wrapper">
							<a href="img/work5.jpg" title="this is a sky image">
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/1 (6).jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Septiany Silalahi</h4>
									<h4 class="team-member-designation"></h4>
									<ul class="social-list">
										<li><a href="https://web.facebook.com/septiany.p.5" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/login?lang=id" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Nicholas Pardosi</h4>
									<h4 class="team-member-designation"></h4>
									<ul class="social-list">
										<li><a href="https://web.facebook.com/nicholassteven.pardosi" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/login?lang=id" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
									</ul>
								</div>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Antonel Manurung</h4>
									<h4 class="team-member-designation"></h4>
									<ul class="social-list">
										<li><a href="https://web.facebook.com/antonel.manurung.1" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://twitter.com/login?lang=id" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
									</ul>
								</div>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class="sub-heading">
								<p>
								Anda dapat bertanya tentang masalah tersebut. Kami akan
								selesaikan itu bersama
								</p>
						...
						<div class="col-md-7">
							<div class="panel-group" id="accordian">
								...
								<?php 
								  ...
								  $con=mysqli_connect('localhost','root','','web_belajarpemrograman');
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
											Web Learn Programming is an online E-learning website <br>here you can learn programming languages, and improve your coding skills	
											</p>
										</div>
									</div>
								</div>
