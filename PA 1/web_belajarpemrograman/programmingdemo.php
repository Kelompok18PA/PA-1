...
<html>
<head>
	<title>Web Belajar Pemrograman</title>
	<!----css file link-->
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
								 ...
								 Berikut adalah bahasa pemrograman yang tersedia:
								 <br>Mulai belajar hari ini
 								</div>
 							</div>
 						</div>
 					</div>
...
<?php
			...
			mysqli_select_db($con,'web_belajarpemrograman');
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                <p>Web Belajar Pemrograman is an excellent learning hub, dedicated to the programmer who want to explore.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>Web Belajar Pemrograman</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              ...
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">me.baba@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
                <dd><a href="tel:#">+6287654921377</a> <span>or</span> <a href="tel:#">+6281278560023</a>
                </dd>
              </dl>
            </div>
